/*
** parse_opt_c.c for src in /afs/epitech.net/users/epitech_2015/hervet_g/public/ok/src
** 
...
static int	insert_item(t_opt_c **begin, int nb1, int nb2)
{
  t_opt_c	*tmp;
...
static int	insert_number(char *str, t_opt_c **begin)
{
  int		idx;
  int		nb[2];
