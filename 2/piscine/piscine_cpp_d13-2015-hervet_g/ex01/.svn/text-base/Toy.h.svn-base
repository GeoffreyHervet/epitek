...
class			Toy
{
  ...
  public:
    ...
    virtual bool	speak(std::string const &sentence){ std::cout << this->getName() << " \"" << sentence << "\"" << std::endl; return true;};
    virtual bool	speak_es(std::string const &){this->setError("wrong mode", __FUNCTION__, Toy::Error::SPEAK); return false;};
